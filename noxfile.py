"""Noxfile for the pytest-repo-structure project."""
...
PROJECT_NAME: str = "pytest-repo-structure"
PACKAGE_NAME: str = "pytest_repo_structure"
REPOSITORY_HOST: str = "github.com"
REPOSITORY_PATH: str = "56kyle/pytest-repo-structure"
